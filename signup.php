...
<main>
    ...
    <scetion class="section-default">
        <form id="formone" onsubmit="return crousa();" name="signform" class="signup-form" action="includes/signup.inc.php" method="post" >
          <input type="text" name="unm" placeholder="Username" minlength="5" maxlength="15" required />
          <span id="errorUser"></span>
          <br/>
          <input type="email" name="mail" placeholder="E-mail" minlength="15" maxlength="50" required/>
          <span id="errorEmail"></span>
          <br/>
          <input type="password" name="pwdr" placeholder="Password" minlength="15" maxlength="25" required/>
          <span id="errorPass"></span>
          <br/>
          <input type="password" name="pwdrc" placeholder="Confirm Password" minlength="15" maxlength="25" required/>
